      ...
      <div className="m-4 w-full h-[400px] bg-white rounded text-center flex flex-col justify-center items-center">
         ...
         <div className="text-center">
           <form className="p-2 flex flex-col">
             ...
             <input className="p-2 w-[250px] md:w-[400px] focus:bg-gray-100 focus:border-b-black border-b-2 border-b-gray-200 m-2 outline-none" type="email" placeholder="Email"/>
             <input className="p-2 w-[250px] md:w-[400px] focus:bg-gray-100 focus:border-b-black border-b-gray-300 border-b-2 m-2 outline-none" type="password" placeholder="Password"/>
             <input className="mt-2 ml-2 w-[250px] md:w-[400px] hover:bg-gray-200 px-2 py-4"  type="submit" value="SIGN UP"/>
           </form>
          </div>
      </div>
     </div>
